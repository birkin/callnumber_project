...
"""
Django settings for ils_location_mapper_project.
...
template_dirs = json.loads( os.environ['CLLNMBR__TEMPLATES_JSON'] )
TEMPLATES = [
    {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': os.environ['CLLNMBR__LOG_PATH'],
            'formatter': 'standard',
        },
        'console':{
            'level':'DEBUG',
    ...
    'loggers': {
        ...
        'callnumber_app': {
            ...
            'handlers': ['logfile'],
            'level': os.environ['CLLNMBR__LOG_LEVEL'],
            'propagate': False
        },
    }
}
...
# CACHES = json.loads( os.environ['CLLNMBR__CACHES_JSON'] )
